...
<script>
	...
	$(document).ready(function(){
		...
		$('.new_state').click(function(){
			uni_modal("New Region","./state/manage.php")
		})
		$('.manage_state').click(function(){
			uni_modal("Manage Region","./state/manage.php?id="+$(this).attr('data-id'))
		})
		$('.delete_state').click(function(){
		_conf("Are you sure to delete this Region?","delete_state",[$(this).attr('data-id')])
		})
		$('#list').dataTable()
	})
