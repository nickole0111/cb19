...
<script>
	...
	$(document).ready(function(){
		...
		$('.new_zone').click(function(){
			uni_modal("New Barangay","./zone/manage.php")
		})
		$('.manage_zone').click(function(){
			uni_modal("Manage Barangay","./zone/manage.php?id="+$(this).attr('data-id'))
		})
		$('.delete_zone').click(function(){
		_conf("Are you sure to delete this barangay?","delete_zone",[$(this).attr('data-id')])
		})
		$('#list').dataTable()
	})
