...
<form action="" id="establishment-frm">
	...
	<div class="form-group">
		<label for="zone_id" class="control-label">Barangay</label>
		...
		$('#establishment-frm').submit(function(e){
			...
			$.ajax({
				...
				if(resp == 1){
					...
					var _msg = "<div class='alert alert-danger text-white err_msg'><i class='fa fa-exclamation-triangle'></i> City already exists.</div>"
					_frm.prepend(_msg)
